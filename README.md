...
I specialize in **AI/ML engineering**, **LLM-based systems**, **clean architecture design**, and **tooling that supports intelligent workflows**.  
These are my key projects showcasing depth in **AI/ML**, **systems design**, and **tooling**.

---

### **Core Skills:**  
Python · LLM Engineering · AsyncIO · C++/Qt · Clean Architecture · System Design · Networking · GitHub Actions
...
- Cross-disciplinary engineering (AI + desktop apps + automation)  
